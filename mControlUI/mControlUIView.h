...
public:
	...
	BEGIN_MSG_MAP(CMControlUIView)
		COMMAND_HANDLER(IDC_SWITCH1, BN_CLICKED, OnBnPushed1)
		COMMAND_HANDLER(IDC_SWITCH2, BN_CLICKED, OnBnPushed2)
		COMMAND_HANDLER(IDC_SWITCH3, BN_CLICKED, OnBnPushed3)
		COMMAND_HANDLER(IDC_SWITCH4, BN_CLICKED, OnBnPushed4)
		COMMAND_HANDLER(IDC_SWITCH5, BN_CLICKED, OnBnPushed5)
		COMMAND_HANDLER(IDC_SWITCH6, BN_CLICKED, OnBnPushed6)
		COMMAND_HANDLER(IDC_SWITCH7, BN_CLICKED, OnBnPushed7)
		COMMAND_HANDLER(IDC_SWITCH8, BN_CLICKED, OnBnPushed8)
		COMMAND_HANDLER(IDC_SWITCH9, BN_CLICKED, OnBnPushed9)
		COMMAND_HANDLER(IDC_SWITCH10, BN_CLICKED, OnBnPushed10)
		COMMAND_HANDLER(IDC_SWITCH11, BN_CLICKED, OnBnPushed11)
		COMMAND_HANDLER(IDC_SWITCH12, BN_CLICKED, OnBnPushed12)
		COMMAND_HANDLER(IDC_SWITCH13, BN_CLICKED, OnBnPushed13)
		COMMAND_HANDLER(IDC_SWITCH14, BN_CLICKED, OnBnPushed14)
		COMMAND_HANDLER(IDC_SWITCH15, BN_CLICKED, OnBnPushed15)
		COMMAND_HANDLER(IDC_SWITCH16, BN_CLICKED, OnBnPushed16)
